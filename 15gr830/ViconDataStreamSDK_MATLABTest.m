...
while ishandle( MessageBox )
  ...
  for SubjectIndex = 1:SubjectCount
    ...
    for SegmentIndex = 1:SegmentCount
      ...
      DATA_out(niklas_bendtner,:) = [Output_GetSegmentGlobalRotationEulerXYZ.Rotation(1:3)',  Output_GetSegmentGlobalTranslation.Translation(1:3)'];
      ...
      if i < N+1
          ...
          Ang(1,i) = Output_GetSegmentGlobalRotationEulerXYZ.Rotation( 1 );
          Ang(2,i) = Output_GetSegmentGlobalRotationEulerXYZ.Rotation( 2 );
          Ang(3,i) = Output_GetSegmentGlobalRotationEulerXYZ.Rotation( 3 );
          i = i + 1;
      end
